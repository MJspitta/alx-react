...
describe("Notification tests", () => {
  ...
  it("renders correct list items", () => {
    ...
    expect(wrapper.find("ul").childAt(0).html()).toEqual('<div><li data-notification-type="default">New course available</li></div>');
    expect(wrapper.find("ul").childAt(1).html()).toEqual('<div><li data-notification-type="urgent">New resume available</li></div>');
    expect(wrapper.find("ul").childAt(2).html()).toEqual(`<div><li data-urgent=\"true\">${getLatestNotification()}</li></div>`);
  });
  ...
  it("renders correctly when listCourses is not passed", () => {
    ...
    expect(wrapper.containsMatchingElement(<div><li data-notification-type="default">No new notification for now</li></div>));
  });
