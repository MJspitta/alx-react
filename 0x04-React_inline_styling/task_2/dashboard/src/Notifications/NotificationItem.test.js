...
describe("Notification Item component", () => {
  ...
  it("renders correct html by passing dummy", () => {
    ...
    expect(wrapper.html()).toEqual('<li class="default_1dv5s2p" data-notification-type="default">test</li>');
  });

  it("renders correct html from test props", () => {
    const wrapper = shallow(<NotificationItem />);
    wrapper.setProps({ html: "<u>test</u>" });
    expect(wrapper.html()).toEqual('<li class="urgent_dixy98" data-urgent="true"><u>test</u></li>')
  });
});
